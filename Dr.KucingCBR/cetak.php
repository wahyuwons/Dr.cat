...
<body style="background-repeat: no-repeat;background-size: cover;" background="image/tes.jpg" onLoad="javascript:window:print()">
<div id="header">
  <div align="center">
    <p>
 ...
 <table border="0">
	...
	<tr>
      <td><b>Contoh kasus </b></td>
      <td><a>Silahkan kunjungi link disamping </a><b><?php echo "$contoh";?></b></td>
