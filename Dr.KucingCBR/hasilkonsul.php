...
<table>
   ...
   <?php
	...
	<td><a href="cetak.php?id=$id&konsultasi= <?php echo $id_konsultasi;?>" target="blank"> Cetak </a></td>
	<!-- <a onClick="return confirm('Yakin ingin hapus?')" href="?p=hapushasilkonsultasi&hapus=
	<?php echo $id_keterangan; ?>">Hapus /  -->
		</tr>
        <?php
		$no++;
		}
