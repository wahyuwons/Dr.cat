			...
			<div>
                <div style="margin-top:10px">
                    <form name="form1" method="post" action="">
						...
						<div id="view"><h3 align="center" class="teal"> Silahkan jawab pertanyaan berikut 
							ini untuk memeriksa gejala yang di alami kucing Anda</h3></div>
                            <?php 
                                $sg = mysqli_query($kon,"select * from gejala");
                                while($dg = mysqli_fetch_array($sg)){
                                    echo
                                    "<tr>
                                        <td class='text-center' width='2%'><input type='checkbox' name='item[]' id_gejala='item[]' 
										value='$dg[id_gejala]'></td>
							...
							if(isset($_POST['periksa'])){
								...
								if($jumlah>200){
									...
									for($i=0; $i < $jumlah; $i++){
										...
										$q=mysqli_query($kon,"insert into hasil_konsultasi(id_user, konsultasi, id_gejala, b1, 
										b2, b3, b4, b5, b6, b7, b8, b9, waktu) value ('$id_user', $konsultasi, '$gejala', '$b1', 
										'$b2', '$b3', '$b4', '$b5', '$b6', '$b7', '$b8', '$b9',  NOW())") or die(mysqli_error());
